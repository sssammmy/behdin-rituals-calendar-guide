        ...
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2">
            <div className="flex-shrink-0 w-10 h-10">
              {/* Blue Fravahar symbol */}
              <svg viewBox="0 0 100 100" className="w-full h-full">
                <path 
                  d="M50,0c-1.04,21.68-16.8,38.63-30.06,45.41c11.3,8.19,17.24,10.95,30.06,10.95 c12.82,0,18.76-2.76,30.06-10.95C66.8,38.63,51.04,21.68,50,0z M50,65c-5.52,0-10-4.48-10-10s4.48-10,10-10s10,4.48,10,10 S55.52,65,50,65z M50,85c-0,0-10.34,15-10.34,15h20.67C60.34,100,50,85,50,85z" 
                  fill="#1f4e8c" 
                />
                <path 
                  d="M50,15.26c0,0-35,15-35,45h70C85,30.26,50,15.26,50,15.26z M29.71,50.93 c-1.51-3.08-0.24-6.8,2.84-8.32c3.08-1.51,6.8-0.24,8.32,2.84c1.51,3.08,0.24,6.8-2.84,8.32 C34.95,55.28,31.22,54.01,29.71,50.93z M50,60c-2.76,0-5-2.24-5-5s2.24-5,5-5s5,2.24,5,5S52.76,60,50,60z M67.45,45.45 c3.08-1.51,6.8-0.24,8.32,2.84c1.51,3.08,0.24,6.8-2.84,8.32c-3.08,1.51-6.8,0.24-8.32-2.84 C63.1,50.68,64.37,46.96,67.45,45.45z" 
                  fill="#1f4e8c" 
                />
              </svg>
            </div>
